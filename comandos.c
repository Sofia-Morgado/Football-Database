 ...
 * Descrição: Implementacao do codigo descrito em comandos.h
*/
...
void comando_A(int cont, lista_equipa le, ht_equipas ht_e){
    ...
    char *ptexto = (char *)malloc(sizeof(char)*MAX_STR);
...
void comando_a(int cont, lista_jogos lj, ht_jogos ht_j, ht_equipas ht_e){
    ...
    char *ptexto_e1 = (char *)malloc(sizeof(char) *MAX_STR);
    /* ptexto_e1 e o ponteiro para o nome da equipa 2 e reservo espaco*/
    char *ptexto_e2 = (char *)malloc(sizeof(char) *MAX_STR);
