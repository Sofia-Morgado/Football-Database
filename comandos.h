/*
 * Ficheiro: coamandos.h
 * Autor: Sofia Morgado (ist: 195675)
 * Descrição: Funcoes que permitem criar equipas e jogos, procura-los no
 * sistema, listar os jogos,alterar as pontuacos do jogo, apagar jogos e
 * encontrar as equipas que venceram amis jogos
*/
